...
image2 = Image.open("images/main.jpg")
image2 = image2.resize((1800, 900), resample=Image.LANCZOS)
...
#
#label_l1 = tk.Label(root, text="Early Detection of Plant Leaf Disease Using Deep Learning Approach",font=("Times New Roman", 30, 'bold'),
